module Admin::ArticlesHelper
  ...
  ## nested elements not showing
  def datepicker_tag
    content_tag :div, class: "input-group row" do
      form_tag admin_articles_path, method: :get do
        concat content_tag :div, "", class: "col-xs-12 col-sm-4", style: "margin-top:5px" do
        ...
        concat content_tag :span, "", class: "input-group-button col-xs-12 col-sm-1", style: "margin-top:5px" do
